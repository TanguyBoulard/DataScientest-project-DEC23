...
from configuration.database import Base, engine,SessionLocal
...
if __name__ == "__main__":
    ...
    nouvel_utilisateur = Item(username="utilisateur1", password="mot_de_passe1",email="ddiopdjibi@gmail.com")
